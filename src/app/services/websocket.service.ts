...
export class WebsocketService {
  ...
  public playersFromServer$: Observable<Player[]> = this.socket.fromEvent('allPlayers');
  ...
  public currentDominoes$: Observable<number[]> = this.socket.fromEvent('currentDominoes');

  // Observable recevant les prochains dominos
  public nextDominoes$: Observable<number[]> = this.socket.fromEvent('nextDominoes');
